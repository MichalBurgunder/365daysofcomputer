# TAKEN FROM https://github.com/Hevenicio/3D-Lorenz-Attractor-simulation-with-python/blob/main/Atrator.py
...
def update(i): # ... craindo a animação
    ...
    ax.set(facecolor = 'k')
    ax.set_axis_off()
    ax.plot(evol[:i,0], evol[:i,1], evol[:i,2], color= (0.8, 0.5, 0.8), lw = 0.9)
