...
*Markup languages* are languages which provide syntaxtical structures for various textual embellishments. These might, for example, include *italicizing* or **bolding**.
...
1. Bolding and italicizing (as mentioned before) 
2. Making a list, such that the spacing is correct
3. Creating tables
4. Displaying source code such that it is easily identifiable. 
